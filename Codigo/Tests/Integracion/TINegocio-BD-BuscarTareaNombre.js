...
describe('hooks', function () {
    ...
    before(async function () {
        ...
        usuario_reg = {
            username: "BuscarTareaNombreTestNEG",
            email: "buscartareanombretestNEG@gmail.com",
            password: "1234"
        };
    ...
    describe("Buscar tarea por nombre", function () {
        ...
        it("Buscar tarea que no existe", async function () {
            await agent.post('/usuarios/login_user')
                .send({ correo: usuario_reg.email, password: usuario_reg.password })
                .then((res) => {
                    this.timeout(30000);
